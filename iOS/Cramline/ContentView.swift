...
struct ContentView: View {
    ...
    @State private var editingItem: CramlineItem?
    ...
    private func row(for item: CramlineItem) -> some View {
        HStack {
            Button {
...
struct EditItemView: View {
    ...
    init(item: CramlineItem?, onSave: @escaping (String, String, Double, Date) -> Void) {
        self.item = item
        self.onSave = onSave
